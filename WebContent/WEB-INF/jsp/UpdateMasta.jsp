...
<form class="needs-validation" novalidate action="UpdateMastaServlet" method="post">
<input type="hidden" name="id" value="${item.id }">
<div class="form-row">
  <div class="container">
  <h3 class="msapace-A">商品情報の更新作成</h3>
    ...
    <div class="col-sm-8">
      <input type="text" value="${item.detail}" name="detail" class="form-control"  required>
      </div>
    </div>
    <div class="row mt-4">
    <div class="col-sm-4 font_big">画像選択</div>
    <div class="col-sm-8">
      <input type="text" value="${item.fileName}" name="fileName" accept="image/*">
      <img id="preview">
      </div>
    </div>
    <div class="row mt-4">
    ...
    <div class="col-sm-8">
      <input type="text" value="${item.stock}" name="stock" class="form-control"  required>
    </div>
    </div>
  <button type="submit" class="btn btn-primary msapace-A">更新</button>
    </div>
  </div>
</form>
<script>
