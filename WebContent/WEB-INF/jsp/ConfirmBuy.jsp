...
<div class="row msapace-A">
  <div class="col-sm-8">
    <h2 style=text-align:center>注文内容を確認します</h2>
    <p>「注文の確定する」ボタンを押して注文してください</p>
     ...
     <div class="container con mt-5">
		  <form action="BuyResultServlet" method="post">
		    <fieldset class="form-group">
			  <h2>ご請求金額  ${bd.totalPrice}円</h2>
			  <h4>合計個数 ${bd.cartitemNum}点</h4>
			  <h4>${bd.deliveryMethodName}</h4>
			  <h4>配送料・手数料 0円</h4>
			<button type="submit" class="btn btn-primary btn-block msapace-A">注文の確定</button>
